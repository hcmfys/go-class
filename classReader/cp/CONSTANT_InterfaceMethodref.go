...
//11
type CONSTANT_InterfaceMethodref struct {
	tag              uint8
	classIndex       uint16
	nameAndTypeIndex uint16
}

func (cls *CONSTANT_InterfaceMethodref) Parse(tag int, r *bufio.Reader) {
...
func (cls *CONSTANT_InterfaceMethodref) Print(index int, m map[int] interface{}) {
	...
	fmt.Println("#"+ strconv.Itoa(index) +"=InterfaceMethodref    #"+ strconv.Itoa(int(nameAndType.nameIndex))+  ".#"+ strconv.Itoa(int(nameAndType.descriptorIndex))  + utf8.utf8 + " " +utf.utf8 +" " +desUtf.utf8)
}